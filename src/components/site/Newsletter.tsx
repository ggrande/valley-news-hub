    ...
    <section className="rounded-lg border bg-[color:var(--ivory)] p-6 sm:p-8">
      <div className="grid items-center gap-6 sm:grid-cols-[1fr_auto]">
        <div>
          ...
          <h3 className="mt-2 font-display text-2xl font-black text-primary">
            The Kanawha Valley Daily
          </h3>
        ...
        {done ? (
          ...
          >
            <input
              ...
              className="h-10 flex-1 rounded-md border bg-background px-3 text-sm focus:border-[color:var(--broadcast)] focus:outline-none"
            />
            <button
              type="submit"
