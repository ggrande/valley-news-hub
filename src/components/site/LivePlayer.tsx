    ...
    >
      ...
      {!playing ? (
        <button
          ...
          className="relative flex h-full w-full flex-col items-center justify-center px-6 text-center cursor-pointer"
        ...
        >
          ...
          <div className="mt-5 flex size-16 items-center justify-center rounded-full bg-white/10 ring-2 ring-white/20 transition-transform hover:scale-105">
            <Play className="ml-1 size-8 text-white/90" fill="currentColor" />
          </div>

          <p className="mt-5 font-display text-xl font-bold">WKNA 49 Live</p>
